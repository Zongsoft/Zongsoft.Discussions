...
namespace Zongsoft.Community.Services
{
	...
	public class MessageService : DataService<Message>
	{
		...
		protected override int OnInsert(IDataDictionary<Message> data, ISchema schema, object state)
		{
		...
		protected override int OnUpdate(IDataDictionary<Message> data, ICondition condition, ISchema schema, object state)
		{
			//更新内容到文本文件中
			data.TryGetValue(p => p.Content, (key, value) =>
			{
