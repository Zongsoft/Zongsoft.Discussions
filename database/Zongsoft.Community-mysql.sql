...
(
	...
	`MostRecentThreadTitle`        varchar(100)      NULL     COMMENT '最新主题标题' COLLATE 'utf8mb4_general_ci',
	`MostRecentThreadAuthorId`     int unsigned      NULL     COMMENT '最新主题作者编号',
	`MostRecentThreadAuthorName`   varchar(50)       NULL     COMMENT '最新主题作者名称' COLLATE 'utf8mb4_general_ci',
	...
	`MostRecentPostAuthorName`     varchar(50)       NULL     COMMENT '最后回帖作者名称' COLLATE 'utf8mb4_general_ci',
...
(
	...
	`VisitorDescription` varchar(500)    NULL     COMMENT '访客描述' COLLATE 'utf8mb4_general_ci',
